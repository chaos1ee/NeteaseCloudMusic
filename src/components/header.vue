  ...
  <div class="header">
    <div class="top">
      <div class="top-wrapper clearfix">
        ...
        <el-menu :default-active="'/'" class="topnav" mode="horizontal" @select="handleSelect" background-color="#242424" text-color="#ccc"
          :router="true" active-text-color="#fff">
          <el-menu-item index="/">
            <span>
              <em>发现音乐</em>
    ...
    <div v-if="subShow" class="sub">
      <div class="wrapper">
        <el-menu :default-active="'/discover'" class="subnav" mode="horizontal" background-color="#c20c0c" text-color="#ccc" :router="true"
